...
int const com::arthenica::ffmpegkit::AbstractSessionDefaultTimeoutForAsynchronousMessagesInTransmit = 5000;

extern void addSessionToSessionHistory(const Session* session);
